...
def draw_box(myimage, draw, bounding_box, line_width, linecolor):
    ...
    tlx = image_width * left
    tly = image_height * top
    
    # box bottom right pixel coords in image
    brx = tlx + (image_width * width)
    bry = tly + (image_height * height)
...
def main():
    photo_name = 'fred-and-ginger.png'
    overlay_name = 'laughing.png'
    # output_name = 'output.jpg'
    use_guides = True
    bucket = 'pez-rekog-image1'
    # output_path = '/tmp/output.jpg'
    output_path = '/Users/pez/Documents/aws-rekognition-developing-applications/work/output.jpg'
